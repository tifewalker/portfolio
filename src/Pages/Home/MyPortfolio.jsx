    ...
    <section className="portfolio--section" id="MyPortfolio">
      ...
      <div className="portfolio--quick--links">
        ...
        <div className="quick--links--grid">
          ...
          <a href="mailto:your.email@example.com" className="quick--link--card email">
            <div className="link--card--header">
          ...
          <a href="https://github.com/yourusername" className="quick--link--card github" target="_blank" rel="noreferrer">
            <div className="link--card--header">
              <svg className="platform--icon" viewBox="0 0 16 16" width="24" height="24" fill="currentColor">
